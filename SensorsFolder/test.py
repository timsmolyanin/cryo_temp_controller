...
def main():    
    sensor1 = DiodeSensor("SensorsFolder\Sensors\ConfigFolder\diodChine.txt", "approx")
    # 
    # Create graf
    # 
    file = open("SensorsFolder\Sensors\ConfigFolder\diodChine.txt")
    ...
    sensor2 = DiodeSensor("SensorsFolder\Sensors\ConfigFolder\diodChine.txt")
    ...
    while True:
        inp = input("Value: ")
        if inp == "diod_approx":
            sensor = DiodeSensor("SensorsFolder\Sensors\ConfigFolder\diodChine.txt", "approx")
        elif inp == "pt1000":
