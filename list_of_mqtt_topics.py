...
list_of_mqtt_topics = [("/devices/HeaterModule/controls/MEAS DAC Vout", 0),
                                 ...
                                 ("/devices/HeaterModule/controls/MEAS REG Power", 0),
                                 ("/devices/HeaterModule/controls/SET SW REG Duty", 0),
                                 ("/devices/HeaterModule/controls/OverCrrent Status", 0),
                                 ("/devices/HeaterModule/controls/Output Voltage State", 0),
                                 ("devices/HeaterModule/controls/LDO Counts Set", 0),
                                 ("/devices/HeaterModule/controls/DAC Measure Count", 0),
